Pod::Spec.new do |s|
    ...
    s.public_header_files = 'NielsenAppSDK.framework/Headers/NielsenAppSDK.h', 'NielsenAppSDK.framework/Headers/NielsenEventTracker.h'
    s.module_map          = 'NielsenAppSDK.framework/Modules/module.modulemap'
