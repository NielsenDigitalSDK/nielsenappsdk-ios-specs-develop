Pod::Spec.new do |s|
    ...
    s.source              = { :http => 'https://raw.githubusercontent.com/nielsendigitalsdk/nielsenappsdk-ios-releases-develop/master/tvOS/AGFNoAd/NielsenAGFNoAdTVOSAppSDK-8.0.0.1.zip' }
