Pod::Spec.new do |s|
    ...
    s.source              = { :http => 'https://raw.githubusercontent.com/nielsendigitalsdk/nielsenappsdk-ios-releases-develop/dynamic_test/iOS/GlobalNoAd/NielsenNoAdAppSDK-8.0.0.2.zip' }
