Pod::Spec.new do |s|
    ...
    s.source              = { :http => 'https://raw.githubusercontent.com/nielsendigitalsdk/nielsenappsdk-ios-releases-develop/dynamic_test/tvOS/Global/NielsenTVOSAppSDK-8.0.0.2.zip' }
