Pod::Spec.new do |s|
    ...
    s.source              = { :http => 'https://raw.githubusercontent.com/nielsendigitalsdk/nielsenappsdk-ios-releases-develop/static_test/iOS/GlobalNoId/NielsenNoIdAppSDK-8.0.0.2.zip' }
